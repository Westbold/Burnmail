...
const pixel = "iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAIAAACQd1PeAAAADElEQVR4nGPQiNoCAAHkATfgdGTkAAAAAElFTkSuQmCC";
function message(id) {
...
try {
  for (const [name, engine] of [["chromium", chromium], ["firefox", firefox]]) {
    ...
    try {
      ...
      await frame.locator("#data-image").evaluate(e => e.decode());
